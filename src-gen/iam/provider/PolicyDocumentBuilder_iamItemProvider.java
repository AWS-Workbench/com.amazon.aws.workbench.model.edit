...
/**
 * This is the item provider adapter for a {@link iam.PolicyDocumentBuilder_iam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolicyDocumentBuilder_iamItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addAssignSids_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM__ASSIGN_SIDS_JAVA_LANG_BOOLEAN_, true, false, false,
	...
	protected void addStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_PolicyDocumentBuilder_iam_statements_software_amazon_awscdk_services_iam_PolicyStatement_AsList_feature",
						"_UI_PolicyDocumentBuilder_iam_type"),
				IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_PolicyDocumentBuilder_iam_type"),
						IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM__GENERATED_CLASS_NAME, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PolicyDocumentBuilder_iam_varName_feature",
								"_UI_PolicyDocumentBuilder_iam_type"),
						IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM__VAR_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PolicyDocumentBuilder_iam_identifier_feature",
						"_UI_PolicyDocumentBuilder_iam_type"),
				IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM__IDENTIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PolicyDocumentBuilder_iam_additionalCode_feature",
						"_UI_PolicyDocumentBuilder_iam_type"),
				IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM__ADDITIONAL_CODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
