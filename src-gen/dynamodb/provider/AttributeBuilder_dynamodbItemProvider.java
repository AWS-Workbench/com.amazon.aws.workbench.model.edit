...
/**
 * This is the item provider adapter for a {@link dynamodb.AttributeBuilder_dynamodb} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB__NAME_JAVA_LANG_STRING_, true, false, false,
	...
	protected void addType_software_amazon_awscdk_services_dynamodb_AttributeType_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_AttributeBuilder_dynamodb_type_software_amazon_awscdk_services_dynamodb_AttributeType__feature",
						"_UI_AttributeBuilder_dynamodb_type"),
				DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB__TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_TYPE_,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_AttributeBuilder_dynamodb_type"),
						DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB__GENERATED_CLASS_NAME, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_AttributeBuilder_dynamodb_varName_feature",
								"_UI_AttributeBuilder_dynamodb_type"),
						DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB__VAR_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_AttributeBuilder_dynamodb_identifier_feature",
						"_UI_AttributeBuilder_dynamodb_type"),
				DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB__IDENTIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_AttributeBuilder_dynamodb_additionalCode_feature",
						"_UI_AttributeBuilder_dynamodb_type"),
				DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB__ADDITIONAL_CODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
