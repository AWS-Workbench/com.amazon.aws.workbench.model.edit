...
/**
 * This is the item provider adapter for a {@link dynamodb.TableBuilder_dynamodb} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableBuilder_dynamodbItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPartitionKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__PARTITION_KEY_WITH_ATTRIBUTE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_AS_REFERENCE,
	...
	protected void addBillingMode_software_amazon_awscdk_services_dynamodb_BillingMode_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TableBuilder_dynamodb_billingMode_software_amazon_awscdk_services_dynamodb_BillingMode__feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__BILLING_MODE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_BILLING_MODE_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addEncryption_software_amazon_awscdk_services_dynamodb_TableEncryption_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TableBuilder_dynamodb_encryption_software_amazon_awscdk_services_dynamodb_TableEncryption__feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__ENCRYPTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_TABLE_ENCRYPTION_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addEncryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TableBuilder_dynamodb_encryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference_feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__ENCRYPTION_KEY_WITH_IKEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_KMS_IKEY_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPointInTimeRecovery_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__POINT_IN_TIME_RECOVERY_JAVA_LANG_BOOLEAN_, true, false,
	...
	protected void addReadCapacity_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__READ_CAPACITY_JAVA_LANG_NUMBER_, true, false, false,
	...
	protected void addRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addReplicationRegions_java_lang_String_AsListPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__REPLICATION_REGIONS_JAVA_LANG_STRING_AS_LIST, true,
	...
	protected void addServerSideEncryption_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__SERVER_SIDE_ENCRYPTION_JAVA_LANG_BOOLEAN_, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSortKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TableBuilder_dynamodb_sortKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference_feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__SORT_KEY_WITH_ATTRIBUTE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addStream_software_amazon_awscdk_services_dynamodb_StreamViewType_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TableBuilder_dynamodb_stream_software_amazon_awscdk_services_dynamodb_StreamViewType__feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__STREAM_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_STREAM_VIEW_TYPE_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTimeToLiveAttribute_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__TIME_TO_LIVE_ATTRIBUTE_JAVA_LANG_STRING_, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addWriteCapacity_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__WRITE_CAPACITY_JAVA_LANG_NUMBER_, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addTableName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__TABLE_NAME_JAVA_LANG_STRING_, true, false, false,
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TableBuilder_dynamodb_generatedClassName_feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__GENERATED_CLASS_NAME, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_TableBuilder_dynamodb_varName_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_TableBuilder_dynamodb_varName_feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__VAR_NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_TableBuilder_dynamodb_identifier_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_TableBuilder_dynamodb_identifier_feature",
						"_UI_TableBuilder_dynamodb_type"),
				DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__IDENTIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DynamodbPackage.Literals.TABLE_BUILDER_DYNAMODB__ADDITIONAL_CODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
