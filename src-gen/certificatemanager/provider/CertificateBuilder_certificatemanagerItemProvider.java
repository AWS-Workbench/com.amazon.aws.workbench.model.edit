...
/**
 * This is the item provider adapter for a {@link certificatemanager.CertificateBuilder_certificatemanager} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CertificateBuilder_certificatemanagerItemProvider extends ItemProviderAdapter
	...
	protected void addDomainName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__DOMAIN_NAME_JAVA_LANG_STRING_,
	...
	protected void addSubjectAlternativeNames_java_lang_String_AsListPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_CertificateBuilder_certificatemanager_subjectAlternativeNames_java_lang_String_AsList_feature",
						"_UI_CertificateBuilder_certificatemanager_type"),
				CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__SUBJECT_ALTERNATIVE_NAMES_JAVA_LANG_STRING_AS_LIST,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addValidationDomains_java_lang_String__java_lang_String_AsMapPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_CertificateBuilder_certificatemanager_validationDomains_java_lang_String__java_lang_String_AsMap_feature",
						"_UI_CertificateBuilder_certificatemanager_type"),
				CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VALIDATION_DOMAINS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_CertificateBuilder_certificatemanager_validationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod__feature",
						"_UI_CertificateBuilder_certificatemanager_type"),
				CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VALIDATION_METHOD_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_VALIDATION_METHOD_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_CertificateBuilder_certificatemanager_type"),
				CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__GENERATED_CLASS_NAME, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_CertificateBuilder_certificatemanager_type"),
						CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VAR_NAME, true,
						false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_CertificateBuilder_certificatemanager_type"),
						CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__IDENTIFIER, true,
						false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_CertificateBuilder_certificatemanager_type"),
				CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__ADDITIONAL_CODE, true, false,
