...
/**
 * This is the item provider adapter for a {@link apigateway.IntegrationResponseBuilder_apigateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegrationResponseBuilder_apigatewayItemProvider extends ItemProviderAdapter
	...
	protected void addStatusCode_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_STRING_, true,
	...
	protected void addContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_IntegrationResponseBuilder_apigateway_contentHandling_software_amazon_awscdk_services_apigateway_ContentHandling__feature",
						"_UI_IntegrationResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__CONTENT_HANDLING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONTENT_HANDLING_,
	...
	protected void addResponseParameters_java_lang_String__java_lang_String_AsMapPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_IntegrationResponseBuilder_apigateway_responseParameters_java_lang_String__java_lang_String_AsMap_feature",
						"_UI_IntegrationResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addResponseTemplates_java_lang_String__java_lang_String_AsMapPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_IntegrationResponseBuilder_apigateway_responseTemplates_java_lang_String__java_lang_String_AsMap_feature",
						"_UI_IntegrationResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_TEMPLATES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSelectionPattern_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_IntegrationResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__SELECTION_PATTERN_JAVA_LANG_STRING_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_IntegrationResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_IntegrationResponseBuilder_apigateway_type"),
						ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__VAR_NAME, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_IntegrationResponseBuilder_apigateway_type"),
						ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__IDENTIFIER, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_IntegrationResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__ADDITIONAL_CODE, true, false, false,
