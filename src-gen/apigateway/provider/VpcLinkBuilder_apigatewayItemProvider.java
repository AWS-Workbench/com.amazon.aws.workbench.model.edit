...
/**
 * This is the item provider adapter for a {@link apigateway.VpcLinkBuilder_apigateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VpcLinkBuilder_apigatewayItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDescription_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_, true, false,
	...
	protected void addTargets_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcLinkBuilder_apigateway_targets_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsList_feature",
						"_UI_VpcLinkBuilder_apigateway_type"),
				ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__TARGETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_LIST,
	...
	protected void addVpcLinkName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_VpcLinkBuilder_apigateway_type"),
				ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__VPC_LINK_NAME_JAVA_LANG_STRING_, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_VpcLinkBuilder_apigateway_type"),
						ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME, false, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_VpcLinkBuilder_apigateway_varName_feature",
								"_UI_VpcLinkBuilder_apigateway_type"),
						ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__VAR_NAME, true, false, false,
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_VpcLinkBuilder_apigateway_identifier_feature",
						"_UI_VpcLinkBuilder_apigateway_type"),
				ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__IDENTIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_VpcLinkBuilder_apigateway_additionalCode_feature",
						"_UI_VpcLinkBuilder_apigateway_type"),
				ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY__ADDITIONAL_CODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
