...
/**
 * This is the item provider adapter for a {@link apigateway.MethodResponseBuilder_apigateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodResponseBuilder_apigatewayItemProvider extends ItemProviderAdapter
	...
	protected void addStatusCode_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_STRING_, true,
	...
	protected void addResponseModels_java_lang_String__software_amazon_awscdk_services_apigateway_IModel_AsMapPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_MethodResponseBuilder_apigateway_responseModels_java_lang_String__software_amazon_awscdk_services_apigateway_IModel_AsMap_feature",
						"_UI_MethodResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_MODELS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IMODEL_AS_MAP,
	...
	protected void addResponseParameters_java_lang_String__java_lang_Boolean_AsMapPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_MethodResponseBuilder_apigateway_responseParameters_java_lang_String__java_lang_Boolean_AsMap_feature",
						"_UI_MethodResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_BOOLEAN_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_MethodResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME, false, false,
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_MethodResponseBuilder_apigateway_varName_feature",
						"_UI_MethodResponseBuilder_apigateway_type"),
				ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__VAR_NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_MethodResponseBuilder_apigateway_type"),
						ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__IDENTIFIER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_MethodResponseBuilder_apigateway_type"),
						ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY__ADDITIONAL_CODE, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
