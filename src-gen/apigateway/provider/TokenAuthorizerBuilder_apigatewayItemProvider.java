...
/**
 * This is the item provider adapter for a {@link apigateway.TokenAuthorizerBuilder_apigateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenAuthorizerBuilder_apigatewayItemProvider extends ItemProviderAdapter
	...
	protected void addHandlerWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__HANDLER_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE,
	...
	protected void addAssumeRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TokenAuthorizerBuilder_apigateway_assumeRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference_feature",
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__ASSUME_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAuthorizerName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__AUTHORIZER_NAME_JAVA_LANG_STRING_, true,
	...
	protected void addResultsCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TokenAuthorizerBuilder_apigateway_resultsCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReference_feature",
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__RESULTS_CACHE_TTL_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentitySource_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__IDENTITY_SOURCE_JAVA_LANG_STRING_, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addValidationRegex_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__VALIDATION_REGEX_JAVA_LANG_STRING_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME, false, false,
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TokenAuthorizerBuilder_apigateway_varName_feature",
						"_UI_TokenAuthorizerBuilder_apigateway_type"),
				ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__VAR_NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_TokenAuthorizerBuilder_apigateway_type"),
						ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__IDENTIFIER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_TokenAuthorizerBuilder_apigateway_type"),
						ApigatewayPackage.Literals.TOKEN_AUTHORIZER_BUILDER_APIGATEWAY__ADDITIONAL_CODE, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
