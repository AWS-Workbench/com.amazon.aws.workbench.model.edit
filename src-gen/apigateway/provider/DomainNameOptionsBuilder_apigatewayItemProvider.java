...
/**
 * This is the item provider adapter for a {@link apigateway.DomainNameOptionsBuilder_apigateway} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainNameOptionsBuilder_apigatewayItemProvider extends ItemProviderAdapter
	...
	protected void addCertificateWithICertificate_software_amazon_awscdk_services_certificatemanager_ICertificate_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__CERTIFICATE_WITH_ICERTIFICATE_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_ICERTIFICATE_AS_REFERENCE,
	...
	protected void addDomainName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_DomainNameOptionsBuilder_apigateway_type"),
				ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__DOMAIN_NAME_JAVA_LANG_STRING_, true,
	...
	protected void addEndpointType_software_amazon_awscdk_services_apigateway_EndpointType_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DomainNameOptionsBuilder_apigateway_endpointType_software_amazon_awscdk_services_apigateway_EndpointType__feature",
						"_UI_DomainNameOptionsBuilder_apigateway_type"),
				ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__ENDPOINT_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ENDPOINT_TYPE_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSecurityPolicy_software_amazon_awscdk_services_apigateway_SecurityPolicy_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_DomainNameOptionsBuilder_apigateway_securityPolicy_software_amazon_awscdk_services_apigateway_SecurityPolicy__feature",
						"_UI_DomainNameOptionsBuilder_apigateway_type"),
				ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__SECURITY_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_SECURITY_POLICY_,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_DomainNameOptionsBuilder_apigateway_type"),
				ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_DomainNameOptionsBuilder_apigateway_type"),
						ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_DomainNameOptionsBuilder_apigateway_type"),
						ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_DomainNameOptionsBuilder_apigateway_type"),
				ApigatewayPackage.Literals.DOMAIN_NAME_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
