 ...
 * @generated
 */
public class UserVerificationConfigBuilder_cognitoItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((UserVerificationConfigBuilder_cognito) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_UserVerificationConfigBuilder_cognito_type")
				: getString("_UI_UserVerificationConfigBuilder_cognito_type") + " " + label;
	}
