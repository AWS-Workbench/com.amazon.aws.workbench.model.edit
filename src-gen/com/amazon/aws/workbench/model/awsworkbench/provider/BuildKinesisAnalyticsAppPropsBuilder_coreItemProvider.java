 ...
 * @generated
 */
public class BuildKinesisAnalyticsAppPropsBuilder_coreItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((BuildKinesisAnalyticsAppPropsBuilder_core) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_BuildKinesisAnalyticsAppPropsBuilder_core_type")
				: getString("_UI_BuildKinesisAnalyticsAppPropsBuilder_core_type") + " " + label;
	}
