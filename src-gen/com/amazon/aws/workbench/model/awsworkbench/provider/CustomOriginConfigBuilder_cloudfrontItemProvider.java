 ...
 * @generated
 */
public class CustomOriginConfigBuilder_cloudfrontItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((CustomOriginConfigBuilder_cloudfront) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_CustomOriginConfigBuilder_cloudfront_type")
				: getString("_UI_CustomOriginConfigBuilder_cloudfront_type") + " " + label;
	}
