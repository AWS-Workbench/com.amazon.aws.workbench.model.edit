 ...
 * @generated
 */
public class AppMeshProxyConfigurationBuilder_ecsItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((AppMeshProxyConfigurationBuilder_ecs) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_AppMeshProxyConfigurationBuilder_ecs_type")
				: getString("_UI_AppMeshProxyConfigurationBuilder_ecs_type") + " " + label;
	}
