 ...
 * @generated
 */
public class UserPoolTriggersBuilder_cognitoItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((UserPoolTriggersBuilder_cognito) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_UserPoolTriggersBuilder_cognito_type")
				: getString("_UI_UserPoolTriggersBuilder_cognito_type") + " " + label;
	}
