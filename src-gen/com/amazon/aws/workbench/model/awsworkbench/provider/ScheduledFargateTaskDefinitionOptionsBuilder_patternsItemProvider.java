 ...
 * @generated
 */
public class ScheduledFargateTaskDefinitionOptionsBuilder_patternsItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((ScheduledFargateTaskDefinitionOptionsBuilder_patterns) object).getGeneratedClassName();
		return label == null || label.length() == 0
				? getString("_UI_ScheduledFargateTaskDefinitionOptionsBuilder_patterns_type")
				: getString("_UI_ScheduledFargateTaskDefinitionOptionsBuilder_patterns_type") + " " + label;
	}
