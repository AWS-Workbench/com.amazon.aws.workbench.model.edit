 ...
 * @generated
 */
public class PasswordPolicyBuilder_cognitoItemProvider extends ItemProviderAdapter
	...
	public String getText(Object object) {
		String label = ((PasswordPolicyBuilder_cognito) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_PasswordPolicyBuilder_cognito_type")
				: getString("_UI_PasswordPolicyBuilder_cognito_type") + " " + label;
	}
