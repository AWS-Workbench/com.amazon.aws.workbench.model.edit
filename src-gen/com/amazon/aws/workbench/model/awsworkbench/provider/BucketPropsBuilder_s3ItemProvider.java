 ...
 * @generated
 */
public class BucketPropsBuilder_s3ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		String label = ((BucketPropsBuilder_s3) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_BucketPropsBuilder_s3_type")
				: getString("_UI_BucketPropsBuilder_s3_type") + " " + label;
	}
