...
/**
 * This is the item provider adapter for a {@link com.amazon.aws.workbench.model.awsworkbench.UserBuilder_iam} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserBuilder_iamItemProvider extends ServiceResourcesItemProvider {
	/**
	...
	protected void addGroups_software_amazon_awscdk_services_iam_IGroup_AsListPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				AwsworkbenchPackage.Literals.USER_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST,
	...
	protected void addManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UserBuilder_iam_managedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList_feature",
						"_UI_UserBuilder_iam_type"),
				AwsworkbenchPackage.Literals.USER_BUILDER_IAM__MANAGED_POLICIES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_LIST,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPasswordWithSecretValue_software_amazon_awscdk_core_SecretValue_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UserBuilder_iam_passwordWithSecretValue_software_amazon_awscdk_core_SecretValue_AsReference_feature",
						"_UI_UserBuilder_iam_type"),
				AwsworkbenchPackage.Literals.USER_BUILDER_IAM__PASSWORD_WITH_SECRET_VALUE_SOFTWARE_AMAZON_AWSCDK_CORE_SECRET_VALUE_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPasswordResetRequired_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_UserBuilder_iam_type"),
				AwsworkbenchPackage.Literals.USER_BUILDER_IAM__PASSWORD_RESET_REQUIRED_JAVA_LANG_BOOLEAN_, true, false,
	...
	protected void addPath_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UserBuilder_iam_path_java_lang_String__feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_UserBuilder_iam_path_java_lang_String__feature", "_UI_UserBuilder_iam_type"),
						AwsworkbenchPackage.Literals.USER_BUILDER_IAM__PATH_JAVA_LANG_STRING_, true, false, false,
	...
	protected void addPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UserBuilder_iam_permissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference_feature",
						"_UI_UserBuilder_iam_type"),
				AwsworkbenchPackage.Literals.USER_BUILDER_IAM__PERMISSIONS_BOUNDARY_WITH_IMANAGED_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addUserName_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						AwsworkbenchPackage.Literals.USER_BUILDER_IAM__USER_NAME_JAVA_LANG_STRING_, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_UserBuilder_iam_generatedClassName_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_UserBuilder_iam_generatedClassName_feature", "_UI_UserBuilder_iam_type"),
						AwsworkbenchPackage.Literals.USER_BUILDER_IAM__GENERATED_CLASS_NAME, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UserBuilder_iam_varName_feature",
								"_UI_UserBuilder_iam_type"),
						AwsworkbenchPackage.Literals.USER_BUILDER_IAM__VAR_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_UserBuilder_iam_identifier_feature",
								"_UI_UserBuilder_iam_type"),
						AwsworkbenchPackage.Literals.USER_BUILDER_IAM__IDENTIFIER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_UserBuilder_iam_additionalCode_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_UserBuilder_iam_additionalCode_feature",
						"_UI_UserBuilder_iam_type"),
				AwsworkbenchPackage.Literals.USER_BUILDER_IAM__ADDITIONAL_CODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
