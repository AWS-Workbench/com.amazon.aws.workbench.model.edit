...
/**
 * This is the item provider adapter for a {@link com.amazon.aws.workbench.model.awsworkbench.VersionOptionsBuilder_lambda} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionOptionsBuilder_lambdaItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public VersionOptionsBuilder_lambdaItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addCodeSha256_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_VersionOptionsBuilder_lambda_codeSha256_java_lang_String__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_codeSha256_java_lang_String__feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__CODE_SHA256_JAVA_LANG_STRING_, true, false,
	...
	protected void addDescription_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VersionOptionsBuilder_lambda_description_java_lang_String__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_description_java_lang_String__feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__DESCRIPTION_JAVA_LANG_STRING_, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addProvisionedConcurrentExecutions_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VersionOptionsBuilder_lambda_provisionedConcurrentExecutions_java_lang_Number__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_provisionedConcurrentExecutions_java_lang_Number__feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__PROVISIONED_CONCURRENT_EXECUTIONS_JAVA_LANG_NUMBER_,
	...
	protected void addRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VersionOptionsBuilder_lambda_removalPolicy_software_amazon_awscdk_core_RemovalPolicy__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_removalPolicy_software_amazon_awscdk_core_RemovalPolicy__feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_,
	...
	protected void addMaxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VersionOptionsBuilder_lambda_maxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_maxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference_feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__MAX_EVENT_AGE_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addOnFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VersionOptionsBuilder_lambda_onFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_onFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference_feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__ON_FAILURE_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addOnSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VersionOptionsBuilder_lambda_onSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_onSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference_feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__ON_SUCCESS_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRetryAttempts_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VersionOptionsBuilder_lambda_retryAttempts_java_lang_Number__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VersionOptionsBuilder_lambda_retryAttempts_java_lang_Number__feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__RETRY_ATTEMPTS_JAVA_LANG_NUMBER_, true,
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_VersionOptionsBuilder_lambda_generatedClassName_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_VersionOptionsBuilder_lambda_generatedClassName_feature",
								"_UI_VersionOptionsBuilder_lambda_type"),
						AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__GENERATED_CLASS_NAME, false, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VersionOptionsBuilder_lambda_varName_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_VersionOptionsBuilder_lambda_varName_feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__VAR_NAME, true, false, false,
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VersionOptionsBuilder_lambda_identifier_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_VersionOptionsBuilder_lambda_identifier_feature",
						"_UI_VersionOptionsBuilder_lambda_type"),
				AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__IDENTIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_VersionOptionsBuilder_lambda_additionalCode_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_VersionOptionsBuilder_lambda_additionalCode_feature",
								"_UI_VersionOptionsBuilder_lambda_type"),
						AwsworkbenchPackage.Literals.VERSION_OPTIONS_BUILDER_LAMBDA__ADDITIONAL_CODE, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns VersionOptionsBuilder_lambda.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VersionOptionsBuilder_lambda"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VersionOptionsBuilder_lambda.class)) {
