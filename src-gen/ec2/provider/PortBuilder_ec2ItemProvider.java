...
/**
 * This is the item provider adapter for a {@link ec2.PortBuilder_ec2} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortBuilder_ec2ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addProtocol_software_amazon_awscdk_services_ec2_Protocol_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Ec2Package.Literals.PORT_BUILDER_EC2__PROTOCOL_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_PROTOCOL_, true,
	...
	protected void addStringRepresentation_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_PortBuilder_ec2_type"),
				Ec2Package.Literals.PORT_BUILDER_EC2__STRING_REPRESENTATION_JAVA_LANG_STRING_, true, false, false,
	...
	protected void addFromPort_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Ec2Package.Literals.PORT_BUILDER_EC2__FROM_PORT_JAVA_LANG_NUMBER_, true, false, false,
	...
	protected void addToPort_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PortBuilder_ec2_toPort_java_lang_Number__feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_PortBuilder_ec2_toPort_java_lang_Number__feature",
						"_UI_PortBuilder_ec2_type"),
				Ec2Package.Literals.PORT_BUILDER_EC2__TO_PORT_JAVA_LANG_NUMBER_, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_PortBuilder_ec2_generatedClassName_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_PortBuilder_ec2_generatedClassName_feature",
						"_UI_PortBuilder_ec2_type"),
				Ec2Package.Literals.PORT_BUILDER_EC2__GENERATED_CLASS_NAME, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PortBuilder_ec2_varName_feature",
								"_UI_PortBuilder_ec2_type"),
						Ec2Package.Literals.PORT_BUILDER_EC2__VAR_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_PortBuilder_ec2_identifier_feature",
								"_UI_PortBuilder_ec2_type"),
						Ec2Package.Literals.PORT_BUILDER_EC2__IDENTIFIER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PortBuilder_ec2_additionalCode_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PortBuilder_ec2_additionalCode_feature",
								"_UI_PortBuilder_ec2_type"),
						Ec2Package.Literals.PORT_BUILDER_EC2__ADDITIONAL_CODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
