...
/**
 * This is the item provider adapter for a {@link ec2.GatewayVpcEndpointBuilder_ec2} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GatewayVpcEndpointBuilder_ec2ItemProvider extends ItemProviderAdapter
	...
	protected void addServiceWithIGatewayVpcEndpointService_software_amazon_awscdk_services_ec2_IGatewayVpcEndpointService_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__SERVICE_WITH_IGATEWAY_VPC_ENDPOINT_SERVICE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IGATEWAY_VPC_ENDPOINT_SERVICE_AS_REFERENCE,
	...
	protected void addSubnets_software_amazon_awscdk_services_ec2_SubnetSelection_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GatewayVpcEndpointBuilder_ec2_subnets_software_amazon_awscdk_services_ec2_SubnetSelection_AsList_feature",
						"_UI_GatewayVpcEndpointBuilder_ec2_type"),
				Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__SUBNETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_LIST,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_GatewayVpcEndpointBuilder_ec2_vpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference_feature",
						"_UI_GatewayVpcEndpointBuilder_ec2_type"),
				Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_GatewayVpcEndpointBuilder_ec2_type"),
						Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__GENERATED_CLASS_NAME, false, false, false,
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_GatewayVpcEndpointBuilder_ec2_varName_feature",
						"_UI_GatewayVpcEndpointBuilder_ec2_type"),
				Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__VAR_NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_GatewayVpcEndpointBuilder_ec2_identifier_feature",
						"_UI_GatewayVpcEndpointBuilder_ec2_type"),
				Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__IDENTIFIER, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_GatewayVpcEndpointBuilder_ec2_type"),
						Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_BUILDER_EC2__ADDITIONAL_CODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
