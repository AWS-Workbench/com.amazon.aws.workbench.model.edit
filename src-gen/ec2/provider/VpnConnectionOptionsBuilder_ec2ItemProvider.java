...
/**
 * This is the item provider adapter for a {@link ec2.VpnConnectionOptionsBuilder_ec2} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VpnConnectionOptionsBuilder_ec2ItemProvider extends ItemProviderAdapter
	...
	protected void addIp_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__IP_JAVA_LANG_STRING_, true, false, false,
	...
	protected void addAsn_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_VpnConnectionOptionsBuilder_ec2_type"),
				Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__ASN_JAVA_LANG_NUMBER_, true, false, false,
	...
	protected void addStaticRoutes_java_lang_String_AsListPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_VpnConnectionOptionsBuilder_ec2_type"),
				Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__STATIC_ROUTES_JAVA_LANG_STRING_AS_LIST, true,
	...
	protected void addTunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpnConnectionOptionsBuilder_ec2_tunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsList_feature",
						"_UI_VpnConnectionOptionsBuilder_ec2_type"),
				Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__TUNNEL_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_TUNNEL_OPTION_AS_LIST,
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_VpnConnectionOptionsBuilder_ec2_type"),
				Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__GENERATED_CLASS_NAME, false, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_VpnConnectionOptionsBuilder_ec2_varName_feature",
						"_UI_VpnConnectionOptionsBuilder_ec2_type"),
				Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__VAR_NAME, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_VpnConnectionOptionsBuilder_ec2_type"),
						Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__IDENTIFIER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_VpnConnectionOptionsBuilder_ec2_type"),
						Ec2Package.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
