...
/**
 * This is the item provider adapter for a {@link ec2.VpcPropsBuilder_ec2} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VpcPropsBuilder_ec2ItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public VpcPropsBuilder_ec2ItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addCidr_java_lang_String_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_VpcPropsBuilder_ec2_cidr_java_lang_String__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_cidr_java_lang_String__feature", "_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__CIDR_JAVA_LANG_STRING_, true, false, false,
	...
	protected void addDefaultInstanceTenancy_software_amazon_awscdk_services_ec2_DefaultInstanceTenancy_PropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_defaultInstanceTenancy_software_amazon_awscdk_services_ec2_DefaultInstanceTenancy__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_defaultInstanceTenancy_software_amazon_awscdk_services_ec2_DefaultInstanceTenancy__feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__DEFAULT_INSTANCE_TENANCY_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_DEFAULT_INSTANCE_TENANCY_,
	...
	protected void addEnableDnsHostnames_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_enableDnsHostnames_java_lang_Boolean__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_enableDnsHostnames_java_lang_Boolean__feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__ENABLE_DNS_HOSTNAMES_JAVA_LANG_BOOLEAN_, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addEnableDnsSupport_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_enableDnsSupport_java_lang_Boolean__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_enableDnsSupport_java_lang_Boolean__feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__ENABLE_DNS_SUPPORT_JAVA_LANG_BOOLEAN_, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addFlowLogs_java_lang_String__software_amazon_awscdk_services_ec2_FlowLogOptions_AsMapPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_flowLogs_java_lang_String__software_amazon_awscdk_services_ec2_FlowLogOptions_AsMap_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_flowLogs_java_lang_String__software_amazon_awscdk_services_ec2_FlowLogOptions_AsMap_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__FLOW_LOGS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_OPTIONS_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGatewayEndpoints_java_lang_String__software_amazon_awscdk_services_ec2_GatewayVpcEndpointOptions_AsMapPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_gatewayEndpoints_java_lang_String__software_amazon_awscdk_services_ec2_GatewayVpcEndpointOptions_AsMap_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_gatewayEndpoints_java_lang_String__software_amazon_awscdk_services_ec2_GatewayVpcEndpointOptions_AsMap_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__GATEWAY_ENDPOINTS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_GATEWAY_VPC_ENDPOINT_OPTIONS_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addMaxAzs_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_maxAzs_java_lang_Number__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_maxAzs_java_lang_Number__feature", "_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__MAX_AZS_JAVA_LANG_NUMBER_, true, false, false,
	...
	protected void addNatGatewayProviderWithNatProvider_software_amazon_awscdk_services_ec2_NatProvider_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_natGatewayProviderWithNatProvider_software_amazon_awscdk_services_ec2_NatProvider_AsReference_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_natGatewayProviderWithNatProvider_software_amazon_awscdk_services_ec2_NatProvider_AsReference_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__NAT_GATEWAY_PROVIDER_WITH_NAT_PROVIDER_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_NAT_PROVIDER_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNatGateways_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_natGateways_java_lang_Number__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_natGateways_java_lang_Number__feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__NAT_GATEWAYS_JAVA_LANG_NUMBER_, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addNatGatewaySubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReferencePropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_natGatewaySubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_natGatewaySubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__NAT_GATEWAY_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSubnetConfiguration_software_amazon_awscdk_services_ec2_SubnetConfiguration_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_subnetConfiguration_software_amazon_awscdk_services_ec2_SubnetConfiguration_AsList_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_subnetConfiguration_software_amazon_awscdk_services_ec2_SubnetConfiguration_AsList_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__SUBNET_CONFIGURATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_CONFIGURATION_AS_LIST,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVpnConnections_java_lang_String__software_amazon_awscdk_services_ec2_VpnConnectionOptions_AsMapPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_vpnConnections_java_lang_String__software_amazon_awscdk_services_ec2_VpnConnectionOptions_AsMap_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_vpnConnections_java_lang_String__software_amazon_awscdk_services_ec2_VpnConnectionOptions_AsMap_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__VPN_CONNECTIONS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_CONNECTION_OPTIONS_AS_MAP,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVpnGateway_java_lang_Boolean_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_vpnGateway_java_lang_Boolean__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_vpnGateway_java_lang_Boolean__feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__VPN_GATEWAY_JAVA_LANG_BOOLEAN_, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVpnGatewayAsn_java_lang_Number_PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_vpnGatewayAsn_java_lang_Number__feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_vpnGatewayAsn_java_lang_Number__feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__VPN_GATEWAY_ASN_JAVA_LANG_NUMBER_, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addVpnRoutePropagation_software_amazon_awscdk_services_ec2_SubnetSelection_AsListPropertyDescriptor(
		...
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString(
						"_UI_VpcPropsBuilder_ec2_vpnRoutePropagation_software_amazon_awscdk_services_ec2_SubnetSelection_AsList_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VpcPropsBuilder_ec2_vpnRoutePropagation_software_amazon_awscdk_services_ec2_SubnetSelection_AsList_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__VPN_ROUTE_PROPAGATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_LIST,
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addGeneratedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_VpcPropsBuilder_ec2_generatedClassName_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_VpcPropsBuilder_ec2_generatedClassName_feature", "_UI_VpcPropsBuilder_ec2_type"),
						Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME, false, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addVarNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_VpcPropsBuilder_ec2_varName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_VpcPropsBuilder_ec2_varName_feature",
								"_UI_VpcPropsBuilder_ec2_type"),
						Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__VAR_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_VpcPropsBuilder_ec2_identifier_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_VpcPropsBuilder_ec2_identifier_feature",
								"_UI_VpcPropsBuilder_ec2_type"),
						Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__IDENTIFIER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdditionalCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_VpcPropsBuilder_ec2_additionalCode_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_VpcPropsBuilder_ec2_additionalCode_feature",
						"_UI_VpcPropsBuilder_ec2_type"),
				Ec2Package.Literals.VPC_PROPS_BUILDER_EC2__ADDITIONAL_CODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns VpcPropsBuilder_ec2.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VpcPropsBuilder_ec2"));
	}
	...
	public String getText(Object object) {
		String label = ((VpcPropsBuilder_ec2) object).getGeneratedClassName();
		return label == null || label.length() == 0 ? getString("_UI_VpcPropsBuilder_ec2_type")
				: getString("_UI_VpcPropsBuilder_ec2_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VpcPropsBuilder_ec2.class)) {
